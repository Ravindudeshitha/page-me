...
var css_248z = ".paginationContainer {\r\n  display: flex;\r\n  flex-direction: column;\r\n  align-items: center;\r\n}\r\n\r\n.tableContainer {\r\n  width: 100%;\r\n  overflow-x: auto;\r\n}\r\n\r\n.paginationControls {\r\n  margin-top: 20px;\r\n  display: flex;\r\n  align-items: center;\r\n  gap: 10px;\r\n}\r\n\r\n.paginationControls button {\r\n  padding: 5px 10px;\r\n  cursor: pointer;\r\n}\r\n\r\n.paginationControls button:disabled {\r\n  cursor: not-allowed;\r\n  opacity: 0.5;\r\n}\r\n\r\n.paginationControls .activePage {\r\n  background-color: #007bff;\r\n  color: white;\r\n}\r\n\r\n.paginationControls .dots {\r\n  padding: 5px;\r\n}";
styleInject(css_248z);

const Pagination = ({ children, rowsPerPageOptions = [2, 10, 15], defaultRowsPerPage = 4, 
//   styleNumber,
designTemplate = true, }) => {
    ...
    const headers = React.Children.toArray(thead?.props.children).filter((child) => {
        return React.isValidElement(child) && child.type === 'tr';
    });
    // Extract rows from tbody
    const rows = React.Children.toArray(tbody?.props.children).filter((child) => {
        return React.isValidElement(child) && child.type === 'tr';
    });
    // //check table element
    // const table= React.Children.toArray(children).find(child => {
    ...
    const [rowsPerPage, setRowsPerPage] = reactExports.useState(defaultRowsPerPage);
    //total pages
    ...
    return (jsxRuntimeExports.jsxs("div", { className: "paginationContainer", children: [jsxRuntimeExports.jsx("div", { className: designTemplate ? 'tableContainer' : 'tableContainerCustom', children: jsxRuntimeExports.jsxs("table", { ...tableProps, children: [jsxRuntimeExports.jsx("thead", { ...theadProps, children: headers }), jsxRuntimeExports.jsx("tbody", { ...tbodyProps, children: paginatedRows })] }) }), jsxRuntimeExports.jsxs("div", { className: "paginationControls", children: [jsxRuntimeExports.jsx("button", { disabled: currentPage === 1, onClick: () => setCurrentPage(currentPage - 1), children: "Prev" }), getVisiblePageNumbers().map((num, index) => typeof num === "number" ? (jsxRuntimeExports.jsx("button", { className: num === currentPage ? "activePage" : "", onClick: () => setCurrentPage(num), children: num }, index)) : (jsxRuntimeExports.jsx("span", { className: "dots", children: "..." }, index))), jsxRuntimeExports.jsx("button", { disabled: currentPage === totalPages, onClick: () => setCurrentPage(currentPage + 1), children: "Next" }), jsxRuntimeExports.jsx("select", { value: rowsPerPage, onChange: (e) => {
                            setRowsPerPage(Number(e.target.value));
                            setCurrentPage(1);
                        }, children: rowsPerPageOptions.map((option) => (jsxRuntimeExports.jsxs("option", { value: option, children: [option, " rows"] }, option))) })] })] }));
};
